export const dict = {
  ...
  "ui.permission.pattern.addToAllowed": "Adicionar à lista de permitidos",
  "ui.permission.pattern.removeFromAllowed": "Remover da lista de permitidos",
  "ui.permission.pattern.addToDenied": "Adicionar à lista de negados",
  "ui.permission.pattern.removeFromDenied": "Remover da lista de negados",
  ...
  "marketplace.searchSkills": "Pesquisar habilidades...",
  "marketplace.filter.all": "Todos os itens",
  "marketplace.filter.installed": "Instalados",
  "marketplace.filter.notInstalled": "Não instalados",
  "marketplace.empty": "Nenhum item encontrado",
  "marketplace.emptySkills": "Nenhuma habilidade encontrada",
  "marketplace.categoryAll": "Todos",
  "marketplace.badge.mcpServer": "Servidor MCP",
  "marketplace.badge.mode": "Modo",
  "marketplace.badge.installed": "Instalado",
  ...
  "marketplace.install.project": "Projeto",
  "marketplace.install.global": "Global",
  ...
  "marketplace.install.submit": "Instalar",
  "marketplace.install.success": "Instalado",
  ...
  "marketplace.remove.confirm":
    "Tem certeza de que deseja remover este(a) {{type}}? Isso removerá o item da sua configuração {{scope}}.",
  "marketplace.remove.cancel": "Cancelar",
  "marketplace.remove.submit": "Remover",
  ...
  "marketplace.remove.scope.project": "projeto",
  "marketplace.remove.scope.global": "global",
}
