...
export const dict = {
  ...
  "marketplace.install.global": "全域",
  "marketplace.install.method": "安裝方法",
  "marketplace.install.prerequisites": "必要條件",
  "marketplace.install.parameters": "參數",
  "marketplace.install.optional": "(選用)",
  "marketplace.install.required": "{{name}} 為必填",
  "marketplace.install.cancel": "取消",
  "marketplace.install.installing": "安裝中...",
  "marketplace.install.submit": "安裝",
  "marketplace.install.success": "已安裝",
  "marketplace.install.done": "完成",
  "marketplace.install.failed": "安裝失敗",
  "marketplace.install.close": "關閉",
  "marketplace.remove.title": "移除 {{name}}？",
  "marketplace.remove.confirm": "確定要移除此 {{type}} 嗎？這將會從您的 {{scope}} 設定中將其移除。",
  "marketplace.remove.cancel": "取消",
  "marketplace.remove.submit": "移除",
  ...
  "marketplace.remove.scope.project": "專案",
  "marketplace.remove.scope.global": "全域",
