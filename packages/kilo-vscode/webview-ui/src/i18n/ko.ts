...
export const dict = {
  ...
  "marketplace.searchSkills": "스킬 검색...",
  "marketplace.filter.all": "모든 항목",
  "marketplace.filter.installed": "설치됨",
  "marketplace.filter.notInstalled": "미설치",
  "marketplace.empty": "항목을 찾을 수 없습니다",
  "marketplace.emptySkills": "스킬을 찾을 수 없습니다",
  "marketplace.categoryAll": "전체",
  "marketplace.badge.mcpServer": "MCP 서버",
  "marketplace.badge.mode": "모드",
  "marketplace.badge.installed": "설치됨",
  ...
  "marketplace.install.global": "전역",
  "marketplace.install.method": "설치 방법",
  "marketplace.install.prerequisites": "필수 조건",
  ...
  "marketplace.install.submit": "설치",
  "marketplace.install.success": "설치 완료",
  ...
  "marketplace.remove.confirm": "이 {{type}}을(를) 제거하시겠습니까? 이렇게 하면 {{scope}} 구성에서 제거됩니다.",
  "marketplace.remove.cancel": "취소",
  "marketplace.remove.submit": "제거",
  ...
  "marketplace.remove.scope.project": "프로젝트",
  "marketplace.remove.scope.global": "전역",
}
