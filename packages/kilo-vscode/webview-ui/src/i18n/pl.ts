export const dict = {
  ...
  "marketplace.tab.skills": "Umiejętności",
  "marketplace.search": "Szukaj...",
  "marketplace.searchSkills": "Szukaj umiejętności...",
  "marketplace.filter.all": "Wszystkie elementy",
  "marketplace.filter.installed": "Zainstalowane",
  "marketplace.filter.notInstalled": "Niezainstalowane",
  "marketplace.empty": "Nie znaleziono elementów",
  "marketplace.emptySkills": "Nie znaleziono umiejętności",
  "marketplace.categoryAll": "Wszystkie",
  "marketplace.badge.mcpServer": "Serwer MCP",
  "marketplace.badge.mode": "Tryb",
  "marketplace.badge.installed": "Zainstalowane",
  ...
  "marketplace.install.global": "Globalny",
  ...
  "marketplace.install.submit": "Zainstaluj",
  "marketplace.install.success": "Zainstalowano",
  ...
  "marketplace.remove.confirm":
    "Czy na pewno chcesz usunąć {{type}}? Spowoduje to usunięcie z Twojej konfiguracji {{scope}}.",
  "marketplace.remove.cancel": "Anuluj",
  "marketplace.remove.submit": "Usuń",
  ...
  "marketplace.remove.scope.project": "projektowej",
  "marketplace.remove.scope.global": "globalnej",
}
