export const dict = {
  ...
  "marketplace.searchSkills": "Rechercher des compétences...",
  "marketplace.filter.all": "Tous les éléments",
  "marketplace.filter.installed": "Installés",
  "marketplace.filter.notInstalled": "Non installés",
  "marketplace.empty": "Aucun élément trouvé",
  "marketplace.emptySkills": "Aucune compétence trouvée",
  "marketplace.categoryAll": "Tout",
  "marketplace.badge.mcpServer": "Serveur MCP",
  "marketplace.badge.mode": "Mode",
  "marketplace.badge.installed": "Installé",
  ...
  "marketplace.install.project": "Projet",
  ...
  "marketplace.install.installing": "Installation...",
  "marketplace.install.submit": "Installer",
  "marketplace.install.success": "Installé",
  ...
  "marketplace.remove.confirm":
    "Êtes-vous sûr de vouloir supprimer ce(tte) {{type}} ? Cela le retirera de votre configuration {{scope}}.",
  "marketplace.remove.cancel": "Annuler",
  "marketplace.remove.submit": "Supprimer",
  ...
  "marketplace.remove.scope.project": "projet",
  "marketplace.remove.scope.global": "globale",
}
