export const dict = {
  ...
  "marketplace.searchSkills": "البحث في المهارات...",
  "marketplace.filter.all": "كل العناصر",
  "marketplace.filter.installed": "مثبت",
  "marketplace.filter.notInstalled": "غير مثبت",
  "marketplace.empty": "لم يتم العثور على عناصر",
  "marketplace.emptySkills": "لم يتم العثور على مهارات",
  "marketplace.categoryAll": "الكل",
  "marketplace.badge.mcpServer": "خادم MCP",
  "marketplace.badge.mode": "وضع",
  "marketplace.badge.installed": "مثبت",
  ...
  "marketplace.install.global": "عام",
  ...
  "marketplace.install.installing": "جارٍ التثبيت...",
  "marketplace.install.submit": "تثبيت",
  "marketplace.install.success": "تم التثبيت",
  ...
  "marketplace.remove.confirm":
    "هل أنت متأكد أنك تريد إزالة الـ {{type}}؟ سيؤدي هذا إلى إزالته من تكوين الـ {{scope}} الخاص بك.",
  "marketplace.remove.cancel": "إلغاء",
  "marketplace.remove.submit": "إزالة",
  ...
  "marketplace.remove.scope.project": "مشروع",
  "marketplace.remove.scope.global": "عام",
}
