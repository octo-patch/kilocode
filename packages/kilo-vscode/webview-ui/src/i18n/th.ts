export const dict = {
  ...
  "marketplace.searchSkills": "ค้นหาทักษะ...",
  ...
  "marketplace.emptySkills": "ไม่พบทักษะ",
  "marketplace.categoryAll": "ทั้งหมด",
  "marketplace.badge.mcpServer": "เซิร์ฟเวอร์ MCP",
  "marketplace.badge.mode": "โหมด",
  "marketplace.badge.installed": "ติดตั้งแล้ว",
  ...
  "marketplace.install.global": "โกลบอล",
  ...
  "marketplace.install.required": "จำเป็นต้องระบุ {{name}}",
  "marketplace.install.cancel": "ยกเลิก",
  "marketplace.install.installing": "กำลังติดตั้ง...",
  "marketplace.install.submit": "ติดตั้ง",
  "marketplace.install.success": "ติดตั้งแล้ว",
  "marketplace.install.done": "เสร็จสิ้น",
  "marketplace.install.failed": "การติดตั้งล้มเหลว",
  "marketplace.install.close": "ปิด",
  "marketplace.remove.title": "เอา {{name}} ออกหรือไม่",
  "marketplace.remove.confirm":
    "คุณแน่ใจหรือไม่ว่าต้องการเอา{{type}}นี้ออก การดำเนินการนี้จะเอาออกจากการตั้งค่า{{scope}}ของคุณ",
  "marketplace.remove.cancel": "ยกเลิก",
  "marketplace.remove.submit": "เอาออก",
  "marketplace.remove.type.mcp": "เซิร์ฟเวอร์ MCP",
  "marketplace.remove.type.skill": "ทักษะ",
  "marketplace.remove.type.mode": "โหมด",
  "marketplace.remove.failed": "ไม่สามารถเอา {{name}} ออกได้",
  "marketplace.remove.scope.project": "โปรเจกต์",
  "marketplace.remove.scope.global": "โกลบอล",
}
