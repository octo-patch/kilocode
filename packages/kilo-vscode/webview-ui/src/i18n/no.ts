...
export const dict = {
  ...
  "ui.permission.pattern.addToAllowed": "Legg til i tillatt-listen",
  "ui.permission.pattern.removeFromAllowed": "Fjern fra tillatt-listen",
  "ui.permission.pattern.addToDenied": "Legg til i blokkert-listen",
  "ui.permission.pattern.removeFromDenied": "Fjern fra blokkert-listen",
  ...
  "marketplace.tab.skills": "Ferdigheter",
  "marketplace.search": "Søk...",
  "marketplace.searchSkills": "Søk etter ferdigheter...",
  ...
  "marketplace.emptySkills": "Ingen ferdigheter funnet",
  "marketplace.categoryAll": "Alle",
  "marketplace.badge.mcpServer": "MCP-server",
  "marketplace.badge.mode": "Modus",
  "marketplace.badge.installed": "Installert",
  ...
  "marketplace.install.project": "Prosjekt",
  ...
  "marketplace.install.submit": "Installer",
  "marketplace.install.success": "Installert",
  "marketplace.install.done": "Ferdig",
  "marketplace.install.failed": "Installasjon mislyktes",
  "marketplace.install.close": "Lukk",
  "marketplace.remove.title": "Fjerne {{name}}?",
  ...
  "marketplace.remove.submit": "Fjern",
  "marketplace.remove.type.mcp": "MCP-server",
  "marketplace.remove.type.skill": "ferdighet",
  "marketplace.remove.type.mode": "modus",
  "marketplace.remove.failed": "Klarte ikke å fjerne {{name}}",
  "marketplace.remove.scope.project": "prosjekt",
