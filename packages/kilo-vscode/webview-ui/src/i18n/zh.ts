...
export const dict = {
  ...
  "marketplace.install.submit": "安装",
  "marketplace.install.success": "已安装",
  "marketplace.install.done": "完成",
  "marketplace.install.failed": "安装失败",
  "marketplace.install.close": "关闭",
  "marketplace.remove.title": "移除 {{name}}？",
  "marketplace.remove.confirm": "您确定要移除此{{type}}吗？这将从您的{{scope}}配置中将其移除。",
  ...
  "marketplace.remove.scope.project": "项目",
  "marketplace.remove.scope.global": "全局",
