export const dict = {
  ...
  "marketplace.searchSkills": "Pretraži vještine...",
  ...
  "marketplace.emptySkills": "Nema pronađenih vještina",
  "marketplace.categoryAll": "Sve",
  "marketplace.badge.mcpServer": "MCP Server",
  "marketplace.badge.mode": "Mod",
  "marketplace.badge.installed": "Instalirano",
  ...
  "marketplace.install.project": "Projekat",
  "marketplace.install.global": "Globalno",
  ...
  "marketplace.install.optional": "(opcionalno)",
  "marketplace.install.required": "{{name}} je obavezno",
  "marketplace.install.cancel": "Otkaži",
  "marketplace.install.installing": "Instaliranje...",
  "marketplace.install.submit": "Instaliraj",
  "marketplace.install.success": "Instalirano",
  "marketplace.install.done": "Završeno",
  "marketplace.install.failed": "Instalacija nije uspjela",
  "marketplace.install.close": "Zatvori",
  "marketplace.remove.title": "Ukloni {{name}}?",
  "marketplace.remove.confirm":
    "Da li ste sigurni da želite ukloniti ovu stavku ({{type}})? Ona će biti uklonjena iz vaše konfiguracije (opseg: {{scope}}).",
  "marketplace.remove.cancel": "Otkaži",
  "marketplace.remove.submit": "Ukloni",
  "marketplace.remove.type.mcp": "MCP server",
  "marketplace.remove.type.skill": "vještina",
  "marketplace.remove.type.mode": "mod",
  "marketplace.remove.failed": "Uklanjanje stavke {{name}} nije uspjelo",
  "marketplace.remove.scope.project": "projekat",
  "marketplace.remove.scope.global": "globalno",
}
